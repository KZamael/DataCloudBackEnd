...
public class PersonApiController implements PersonAPI {
	...
	private static TreeMap<Long, Person> initialHash() {
		...
		data.put(123L, new Person(new Long(123), 
				new Name("FirstName","Bruce","text", new Validation(true, 3)), 
				new Name("LastName","Wayne","text", new Validation(true, 3)), 
		...
		data.put(231L, new Person(new Long(231), 
				new Name("FirstName","Joseph","text", new Validation(true, 3)), 
				new Name("LastName","Joestar","text", new Validation(true , 3)), 
		...
		data.put(331L, new Person(new Long(331), 
				new Name("FirstName","Doctor","text", new Validation(true, 3)), 
				new Name("LastName","Gallifrey","text", new Validation(true, 3)), 
